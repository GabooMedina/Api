...
//                corresponds to your MariaDB server version for the right syntax to use near '?' at line 1
    ...
    public void noMayor(java.awt.event.KeyEvent evt) throws SQLException {
    ...
    private void ActualizarStock() {
        for (int i = 0; i < jbtVentas.getRowCount(); i++) {
            int id = Integer.parseInt(jbtVentas.getValueAt(i, 1).toString());
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 0, 740, 150));
